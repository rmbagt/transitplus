...
export default function FAQ() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-10 h-3/5 bg-gradient-to-b from-blue-400 to-transparent" />
      <div className="z-20 w-full max-w-3xl">
        <h1 className="mb-8 text-center text-4xl font-extrabold tracking-tighter text-white md:text-5xl">
